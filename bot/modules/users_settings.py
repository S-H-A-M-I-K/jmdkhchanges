...
Examples:
1. <code>{escape('<b>@ShamikSupport</b>')}</code> 
This will give output of:
<b>@ShamikSupport</b>  <code>50MB.bin</code>.

2. <code>{escape('<code>@ShamikSupport</code>')}</code> 
This will give output of:
<code>@ShamikSupport</code> <code>50MB.bin</code>.
